<aside
    class="fixed xl:left-2/3 lg:left-3/4 lg:w-42 top-3 max-w-md mb-4 break-inside p-6 rounded-xl bg-white dark:bg-slate-800  bg-clip-border shadow-lg w-64"
    aria-label="Sidebar">
    <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
        <div class="text-center">
            <img src="https://mdbcdn.b-cdn.net/img/new/avatars/8.webp" class="rounded-full w-16 mb-2 mx-auto"
                alt="Avatar" />
